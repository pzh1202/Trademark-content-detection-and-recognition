...
data_dir = '/home/csy/ICDAR/icpr/train_1000/'
...
model_weights_path = 'model/mbv3_weights_%s.{epoch:03d}-{val_loss:.3f}.h5' \
                     % train_task_id
saved_model_file_path = 'saved_model/mbv3_east_model_%s.h5' % train_task_id
# saved_model_weights_file_path = 'saved_model/mbv3_east_model_weights_%s.h5'\
#                                 % train_task_id
saved_model_weights_file_path ='model/mbv3_weights_3T640.004-0.156.h5'
pixel_threshold = 0.9
